          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary/80 p-12 md:p-16 text-center text-white shadow-2xl">
            <div className="relative z-10">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Browse all our products or use our search to find exactly what
                you need
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href={ROUTES.HOME}>
                  <Button
                    size="lg"
                    variant="outline"
                    className="h-14 px-8 text-lg rounded-full border-2 border-white/30 bg-white/10 hover:bg-white/20 text-white"
                  >
                    Back to Home
                  </Button>
                </Link>
