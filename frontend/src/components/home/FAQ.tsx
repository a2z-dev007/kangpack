      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:w-[450px] lg:sticky lg:top-32 w-full">
          ...
          <h2 className="text-4xl md:text-6xl leading-[1.1] mb-6 tracking-tighter font-bold">
            ...
            <br />
            <span className="text-white/40">Asked</span>
          </h2>
          <p className="text-white/40 text-[16px] md:text-lg xl:text-xl leading-relaxed max-w-[400px] mb-10 lg:mb-0">
              ...
              <div key={i} className="border-b border-white/5">
                ...
                >
                  <div className="flex items-center gap-6 md:gap-24">
                    <span className="text-[12px] md:text-[16px] text-white/30 font-mono w-6 md:w-8">
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <span
                      className={`text-[15px] md:text-[20px] xl:text-[24px] 2xl:text-[28px] font-bold md:font-medium tracking-tight transition-colors duration-300 ${openIndex === i ? "text-white" : "text-white/70 group-hover:text-white"}`}
                    >
                      {faq.q}
                    </span>
                  </div>
                  <div className="flex-shrink-0 ml-4">
                    <div
                      className={`w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center transition-all duration-300 ${openIndex === i ? "btn-premium border-none" : "text-white/50 border border-white/10 bg-white/5 hover:text-white"}`}
                    >
                      {openIndex === i ? (
                ...
                <AnimatePresence mode="wait">
                  {openIndex === i && (
                    ...
                    >
                      <p className="pb-8 pl-12 md:pl-[120px] lg:pl-[136px] xl:pl-[160px] text-white/55 leading-relaxed text-[15px] md:text-[18px] xl:text-[20px] max-w-4xl">
                        {faq.a}
                      </p>
                    </motion.div>
                  )}
