...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[14%] sm:top-[15%] md:top-[16%] z-30 w-full text-center px-4 sm:px-6">
        <motion.div
        ...
        >
          <div className="h-[1px] w-10 sm:w-12 bg-white/30 mb-0.5 sm:mb-1" />
          <p className="text-white/80 text-[10px] sm:text-xs md:text-sm font-bold uppercase tracking-[0.3em] sm:tracking-[0.4em]">
            Precision Crafted
          </p>
          <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-light tracking-tight italic">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none overflow-hidden">
        <motion.h1
          ...
          className="text-[13vw] sm:text-[13vw] md:text-[14vw] lg:text-[12vw] xl:text-[10vw] 2xl:text-[13vw] font-black leading-none tracking-[-0.04em] select-none uppercase text-center relative pointer-events-auto flex items-center justify-center z-10"
        >
          ...
          {"ANYWHERE".split("").map((letter, i) => (
            <motion.span
              ...
              className="relative inline-block transition-all duration-300 bg-clip-text text-transparent cursor-default px-[0.015em] py-8 sm:py-12 bg-white/0"
              style={{
      ...
      <div className="relative z-20 w-full max-w-7xl px-4 flex flex-col items-center mt-auto mb-6 sm:mb-8 md:mb-12 perspective-[1200px] pointer-events-none">
        <motion.div
          style={{ y: bagParallax }}
          initial={{ y: 100, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1.4, ease: [0.16, 1, 0.3, 1] }}
          className="relative w-full flex flex-col md:flex-row justify-center items-center"
        >
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-[85%] sm:w-[75%] md:w-[75%] lg:w-[80%] xl:w-[70%] max-w-[340px] sm:max-w-[420px] md:max-w-[620px] xl:max-w-[700px] 2xl:max-w-[850px]"
            >
              <img
                src="/assets/bag.png"
                alt="Kangpack Product"
                className="w-full h-auto object-contain drop-shadow-[0_30px_50px_rgba(0,0,0,0.5)] scale-105"
              />
              {/* Dynamic Shadow that follows the tilt */}
              <motion.div
                className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[60%] h-10 bg-black/40 blur-[30px] rounded-full -z-10"
                style={{
          ...
          <motion.div
            ...
            className="flex md:hidden flex-col items-center gap-3 mt-4 sm:mt-6 pointer-events-auto"
          >
            <div className="flex flex-col items-center gap-0.5">
              <span className="text-white/40 text-[9px] uppercase tracking-[0.25em] font-bold">
                Unveiling
              </span>
              <p className="text-white text-base font-light italic tracking-tight">
                Work without limits
              </p>
            </div>
            <Link href="/products">
              <PrimaryButton className="btn-premium py-3 px-6 text-xs">Shop Now</PrimaryButton>
            </Link>
          </motion.div>
        </motion.div>
      </div>
