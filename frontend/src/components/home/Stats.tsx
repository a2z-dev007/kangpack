...
const Stats: React.FC = () => {
  ...
  return (
    <section className="bg-transparent py-16 md:py-24 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12 md:mb-16">
          ...
          <div className="w-full lg:w-1/4">
            ...
            >
              <div className="w-2.5 h-2.5 bg-[#a67c52] rounded-[2px] shadow-[0_0_8px_#a67c52]" />
              <span className="text-[11px] font-bold uppercase tracking-widest text-[#a67c52] mt-0.5">
                Stats & Facts
              </span>
            </motion.div>
          </div>
          ...
          <div className="w-full lg:w-3/4">
            ...
            >
              <span className="heading-gradient underline decoration-[#a67c52]/20 underline-offset-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
          {statsData.map((stat, index) => (
            ...
            >
              {/* Number and Suffix */}
              <div className="text-6xl md:text-7xl lg:text-8xl font-black text-[#a67c52] drop-shadow-[0_0_15px_rgba(166,124,82,0.25)] leading-none mb-6 flex items-baseline">
                <SlotCounter
                  value={stat.value}
                  duration={2}
                  animateOnVisible={{
                ...
                />
                <span className="ml-1 text-[#a67c52]">{stat.suffix}</span>
              </div>
              ...
              <p className="text-sm md:text-base text-white/40 font-medium leading-relaxed max-w-sm">
                {stat.description}
              </p>
            </motion.div>
          ))}
